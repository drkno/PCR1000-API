...
namespace PCR1000.Async
{
    /// <summary>
    /// PCR1000 COM Port Communications Class
    /// </summary>
    public class PcrSerialComm
    {
        /// <summary>
        ...
        public async Task<bool> Send(string cmd)
        {
        ...
        public async Task<string> SendWait(string cmd, bool overrideAutoupdate = false)
        {
        ...
        public async Task<string> GetLastReceived()
        {
        ...
        public async Task<string> GetPrevReceived()
        {
        ...
        public async Task<bool> PcrOpen()
        {
        ...
        /// </summary>
        /// <returns>Success</returns>
        public async Task<bool> PcrClose()
        {
